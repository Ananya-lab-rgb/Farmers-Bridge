...
export default function Landing() {
    return (
        <div className="min-h-screen bg-[#FDFCF7] text-[#1A2E1A] font-sans selection:bg-[#C5E1A5] selection:text-[#1A2E1A]">
            ...
            <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-[#E8E8E8]">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-[#4A4A4A]">
                        <Link to="/browse-equipment" className="hover:text-[#2E7D32] transition-colors">Equipment</Link>
                        <Link to="/feed" className="hover:text-[#2E7D32] transition-colors">Community Feed</Link>
                        <Link to="/browse-laborers" className="hover:text-[#2E7D32] transition-colors">Find Laborers</Link>
                    </div>
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <div className="flex items-center gap-3 bg-[#E8F5E9] px-6 py-2 rounded-2xl border-2 border-[#C5E1A5]">
                                <SpeakButton textToSpeak="Welcome to Farmer Bridge. The premier digital ecosystem for farmers, laborers, and equipment providers. Click the green button to start your journey." />
                                <span className="font-bold text-[#2E7D32] text-sm leading-tight">Listen to<br />Description</span>
                            </div>
                        </div>
            ...
            <section id="features" className="py-32 px-6">
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <Link to={feature.path} key={i} className="block p-10 rounded-[2.5rem] bg-white border border-gray-100 shadow-sm hover:shadow-xl hover:border-[#2E7D32]/20 transition-all group">
            ...
            {/* About Section */}
            <section id="about" className="py-20 px-6 bg-white border-y border-[#F0F0F0]">
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-sm font-bold text-[#2E7D32] uppercase tracking-[0.3em] mb-4">Our Mission</h2>
                        <h3 className="text-4xl md:text-5xl font-extrabold text-[#1A2E1A] mb-6">Bridging the Gap for Rural Farmers</h3>
                        <p className="text-lg text-[#4A4A4A] leading-relaxed mb-6">
                            FarmerBridge was born out of a simple necessity: to provide technologically advanced yet highly accessible farming solutions to those who need them most. We understand the challenges of rural agriculture and have designed a system that requires minimal technical knowledge while offering maximum productivity.
                        </p>
                        <p className="text-lg text-[#4A4A4A] leading-relaxed">
                            Through innovative voice assistance, easy pictorial navigation, and deep community roots, we're not just another app—we're your trusted digital farming partner.
                        </p>
                    </div>
                    <div className="relative">
                        <img
